...
import com.syd.elderguard.fragment.EChartsAndroidFragment;
import com.syd.elderguard.fragment.RelationFragment;
import com.syd.elderguard.fragment.SettingsFragment;
import com.syd.elderguard.fragment.Visition.VisitionFragment;
import com.syd.elderguard.fragment.profile.ProfileFragment;
import com.syd.elderguard.fragment.serviceFragment;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, BottomNavigationView.OnNavigationItemSelectedListener, ClickUtils.OnClick2ExitListener, Toolbar.OnMenuItemClickListener {
    ...
    private void initHeader() {
        ...
        tvAvatar.setText(TokenManager.getInstance().getLoginUser().getUsername());
        tvSign.setText(TokenManager.getInstance().getLoginUser().getCrdate());
